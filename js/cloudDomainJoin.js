...
(function (CloudExperienceHost) {
    (function (CloudDomain) {
        ...
        function getCommonFeatures(allServerFeatures) {
            ...
            // Remove the MmpcRedirectFeature if the MmpcRedirect VelocityKey is not enabled.
            if (!CloudExperienceHostAPI.FeatureStaging.tryGetIsFeatureEnabled("MmpcRedirect").value) {
                commonFeatures = commonFeatures.filter(function (feature) {
                    return feature != "MmpcRedirectFeature";
                });
            }
