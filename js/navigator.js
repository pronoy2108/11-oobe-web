    ...
    class Navigator {
        ...
        _processReconnectHandlerCxid(preferAppResultToId) {
            ...
            if (reconnectFrequency === CloudExperienceHost.ReconnectFrequency.ByPolicy) {
                reconnectFrequency = CloudExperienceHostAPI.UtilStaticsCore.getLicensingPolicyValue("OOBE-Reconnect-Network");
            }
        ...
        _isInplaceResumeNeeded(frequency) {
            ...
            if (!this._currentNode.skipReconnectHandler &&
                (((frequency === CloudExperienceHost.ReconnectFrequency.Once) && !CloudExperienceHost.Storage.VolatileSharableData.getItem("InPlaceResumeValues", "reconnectionHandled")) ||
