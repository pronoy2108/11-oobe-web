...
define([
    ...
    class accountSetupCategoryViewModel {
        constructor(resourceStrings, sessionUtilities) {
            // Constants
            this.MAX_AAD_REGISTRATION_WAIT_TIME_IN_MILLISECONDS = 3600000;
            this.DEVICE_REGISTRATION_INTERVAL_WAIT_TIME_IN_MILLISECONDS = 300000;
        ...
        waitForAadRegistrationAsync() {
            ...
            let aadRegistrationTimeoutPromise = WinJS.Promise.timeout(this.MAX_AAD_REGISTRATION_WAIT_TIME_IN_MILLISECONDS).then(() => {
                this.commercialDiagnosticsUtilities.logInfoEvent(
