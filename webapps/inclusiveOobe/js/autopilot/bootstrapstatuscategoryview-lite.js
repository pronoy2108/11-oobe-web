...
define([
    ...
    class bootstrapStatusCategoryView {
        constructor(
            ...
            let categoryLabelRow = parentTable.insertRow();

            // Create:  <td class="glyph-cell-lite" aria-hidden="true"></td>
            this.categoryLabelIconCell = categoryLabelRow.insertCell();
            this.categoryLabelIconCell.className = "glyph-cell-lite";
            ...
            // Create:  <td></td>
            this.categoryLabelCell = categoryLabelRow.insertCell();
            ...
            // Create:  <td></td>
            this.chevronDetailsButtonCell = categoryLabelRow.insertCell();
            ...
            let categoryStatusRow = parentTable.insertRow();

            // Insert an empty cell so category status animation lines up with the category label
            categoryStatusRow.insertCell();

            // Create:  <td></td>
            this.categoryStatusIconCell = categoryStatusRow.insertCell();
            ...
            // Set up the UI for the category status.
            this.progressAnimationRow = parentTable.insertRow();

            // Insert an empty cell so progress animation lines up with the category label
            this.progressAnimationRow.insertCell();

            // Create:  <td></td>
            this.progressAnimationCell = this.progressAnimationRow.insertCell();
            this.progressAnimationCell.colSpan = "2";
            ...
            // Set up the UI for the category status.
            let subcategoriesRow = parentTable.insertRow();

            // Insert an empty cell so subcategories line up with the category label
            subcategoriesRow.insertCell();

            // Create:  <td></td>
            this.subcategoriesCell = subcategoriesRow.insertCell();
            this.subcategoriesCell.colSpan = "2";
