    ...
    class OOBESettingsSelector {
        launchAsync() {
            ...
            return new WinJS.Promise((completeDispatch /*, errorDispatch, progressDispatch */) => {
                self.recordAadcApplicabilityBreadcrumbAsync(CloudExperienceHostAPI.FeatureStaging.isOobeFeatureEnabled("CxhAadcBehavior") ? 1 : 0 /* breadcrumbValue */).then(() => {
        ...
        selectPrivacySettingsPage() {
            ...
            if (multiPageSettingsSupportedRegionList.includes(region) || CloudExperienceHostAPI.FeatureStaging.isOobeFeatureEnabled("OobeSettingsMultiAllRegions"))
            {
