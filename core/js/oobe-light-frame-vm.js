...
define(['lib/knockout', 'legacy/appViewManager', 'legacy/navigationManager', 'legacy/core'], (ko, appViewManager, navManager, core) => {
    ...
    class LiteFrameViewModel {
        constructor() {
            ...
            this._anim = null;
            this.showLightFooter = CloudExperienceHostAPI.FeatureStaging.isOobeFeatureEnabled("DesktopLiteOobe") && CloudExperienceHostAPI.Environment.isFullscreenCXHRunning;
        ...
        update(updateType, completeDispatch, errorDispatch, updateTag) {
            ...
            switch (updateType) {
                ...
                case CloudExperienceHost.FrameViewModelUpdateType.SetDisplayModeFullScreen:
                    if (CloudExperienceHostAPI.FeatureStaging.isOobeFeatureEnabled("AllowDisplayModeChange")) {
